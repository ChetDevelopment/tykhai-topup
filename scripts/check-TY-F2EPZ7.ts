...
async function checkOrder() {
  ...
  if (data.data && data.data.acknowledgedDateMs) {
    console.log("✅ PAID in Bakong at:", new Date(data.data.acknowledgedDateMs).toISOString());
    ...
    console.log("⏳ Not paid yet in Bakong");
  }
